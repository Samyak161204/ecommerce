    ...
    <div className="border-t pt-14">
      ...
      <div>
        {cartData.map((item, index) => {
          ...
          if (!productData) return null; // 🛑 Prevents undefined errors
          ...
          return (
            ...
            >
              <div className="flex items-start gap-6">
                <img className="w-16 sm:w-20" src={productData.image?.[0] || assets.placeholder} alt={productData.name || "Product"} />
                <div>
